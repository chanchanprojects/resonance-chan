...
export function DashboardSidebar() {
  ...
  const otherMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:c.notesacc12@gmail.com",
      icon: HeadphonesIcon
    }
  ]
    ...
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-col gap-4 pt-4">
        <div className="flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
          ...
          />
          <span className="group-data-[collapsible=icon]:hidden font-bold text-lg tracking-tighter text-foreground">
            Resonance
          </span>
            ...
            <OrganizationSwitcher
              ...
              appearance={{
                elements: {
                  ...
                  organizationSwitcherTrigger: "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! pr-2! py-1! gap-3! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:p-1! data-[active=true]:shadow-[0px_1px_1px_0px_rgba(44,54,53,0.03),inset_0px_0px_0px_2px_white]",
