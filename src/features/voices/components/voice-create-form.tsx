...
import { AlignLeftIcon, AudioLinesIcon, CheckIcon, ChevronsUpDownIcon, FileAudioIcon, FolderOpenIcon, GlobeIcon, LayersIcon, MicIcon, PauseIcon, PlayIcon, TagIcon, UploadIcon, XIcon } from "lucide-react"
...
export function VoiceCreateForm({
  ...
  return (
    ...
    >
      <div
        className={cn(
          scrollable ? "no-scrollbar flex flex-col gap-6 overflow-y-auto px-4" : "flex flex-col gap-6"
        )}
      >
